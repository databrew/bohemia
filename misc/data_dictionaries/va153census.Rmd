...
data_dict <- generate_data_dictionary(path = '../../forms/va153census/va153census.xlsx',
                                      language = lang, 
...
ht <- bohemia::prettify(dd, nrows = nrow(dd), download_options = TRUE)
htmltools::save_html(html = ht, file = '../../rpackage/vatool/misc/dictionary_sw.html')
```
