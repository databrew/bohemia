...
# Xing fixes to erroneous deaths in VA form

iid = "'ff7a7064-2489-47cc-8d2a-1965e0587c76'"																									
implement(id = None, query = "UPDATE clean_minicensus_main SET any_deaths_past_year='No', how_many_deaths='NA' WHERE instance_id=" + iid + "; DELETE FROM clean_minicensus_repeat_death_info WHERE instance_id= " + iid + ";", who = 'Xing Brew')																									
